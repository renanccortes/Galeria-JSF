 ...
 * @param <Entidade>
 */
public class LazyTableGenerico<Entidade> extends LazyDataModel<Entidade> {
    ...
    public LazyTableGenerico(ServiceGenerico service) {
        this.service = service;
        filtrosOperadorAND = new HashMap<String, Object>();
        filtrosOperadorOR = new HashMap<String, Object[]>();
    }

    @Override
    public List<Entidade> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {

        System.out.printf("\n===================== loading LazyTableGenerico, set page size: %d\n", pageSize);
        ...
        int linhas = service.countLinhas(filtrosOperadorAND, filtrosOperadorOR);
        setRowCount(linhas);
        return listModelos;
    }
